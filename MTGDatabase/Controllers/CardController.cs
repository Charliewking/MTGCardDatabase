...
namespace MTGDatabase.Controllers
{
    ...
    public class CardController : Controller
    {
        ...
        public async Task<IActionResult> GetAllCards()
        {
            ...
            CloudTable table = client.GetTableReference("card");
        ...
        {
            CloudTable table = GetStorageAccount().CreateCloudTableClient().GetTableReference("card");
            ...
            await table.ExecuteAsync(TableOperation.Insert(newCard));
        }
